...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <a class=\"navbar-brand\" href=\"index.jsp\" style=\"color: black\">MI LIGA</a>\n");
      out.write("                </div>\n");
      ...
      out.write("        ");
            ...
            while (listado.next()) { 
                ...
                out.println("<td>" + listado.getString("numero_jornada") + "</td>");
                out.println("<td>" + listado.getString("fecha") + "</td>");
                out.println("<td>" + listado.getString("hora") + "</td>");
                out.println("<td>" + listado.getString("resultado") + "</td>");
                out.println("<td>" + listado.getString("equipo_local") + "</td>");
                out.println("<td>" + listado.getString("equipo_visitante") + "</td>");
      ...
      out.write("                <tr>\n");
      out.write("                    <td>");
      out.print( listado.getInt("Numero de jornada"));
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( listado.getDate("Fecha"));
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( listado.getTime("Hora"));
      out.write("</td>\n");
      out.write("                    <td>");
